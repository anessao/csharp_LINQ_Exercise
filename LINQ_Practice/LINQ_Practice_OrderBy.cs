...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(a => a.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(a => a.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(a => a.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(a => a.LastName).ToList();
